 ...
 * @date 2019/6/2　14:55.
 */
public abstract class QuickPermissionResult {
    ...
    public void onPermissionsAccess(int requestCode) {
        QuickPermissionLog.d("onPermissionsAccess：code =" + requestCode);
    }
    ...
    public void onPermissionsDismiss(int requestCode, @NonNull List<String> permissions) {
        QuickPermissionLog.d("onPermissionsDismiss：code =" + requestCode + " " + permissions.toString());
    }
    /**
    ...
    public boolean onDismissAsk(int requestCode, @NonNull List<String> permissions) {
        QuickPermissionLog.d("onDismissAsk：code =" + requestCode + " " + permissions.toString());
        return false;
    }
}
