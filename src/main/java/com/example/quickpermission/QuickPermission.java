...
public class QuickPermission {
     ...
     * 请求权限的结果回调
     */
    private QuickPermissionResult mResult = null;
    /**
    ...
    protected QuickPermissionResult getResult() {
        return mResult;
    }
     ...
     * @return
     */
    public void setResult(QuickPermissionResult result) {
        this.mResult = result;
    }
     ...
     * @return
     */
    public static QuickPermission build() {
        return new QuickPermission();
    }
     ...
     * @return
     */
    public QuickPermission mRequestCode(int requestCode) {
        this.mRequestCode = requestCode;
        return this;
    }
     ...
     * @return
     */
    public QuickPermission mResult(QuickPermissionResult result) {
        this.mResult = result;
        return this;
    }
     ...
     * @return
     */
    public QuickPermission mContext(@NonNull Activity context) {
     ...
     * @return
     */
    public QuickPermission mPerms(@NonNull String... permissions) {
    ...
    public boolean hasPermission(@NonNull Context context, @NonNull String... permissions) {
        return QuickPermissionHelper.getInstance().hasPermission(context, permissions);
    }
    ...
    protected boolean hasDismissAsk(@NonNull Activity context, @NonNull String permission) {
        return QuickPermissionHelper.getInstance().hasDismissAsk(context, permission);
    }
    ...
    public boolean shouldShowRequestPermissionRationale(@NonNull Activity context, String permission) {
        return QuickPermissionHelper.getInstance().shouldShowRequestPermissionRationale(context, permission);
    }
    ...
    public void requestPermission(@NonNull Activity context, @NonNull String... permissions) {
        if (mResult == null) {
            ...
            //申请权限但是不需要权限结果回调
            QuickPermissionHelper.getInstance().requestPermission(context, permissions);
            return;
        }
        ...
        QuickPermissionHelper.getInstance().requestPermission(context, mRequestCode, mResult, mPerms);
    ...
    public void openAppDetails(@NonNull final Activity context, String... permissionShow) {
        QuickPermissionHelper.getInstance().openAppDetails(context, permissionShow);
    }
    /**
     * Open the APP's permission details Settings
     * 打开 APP 的权限详情设置
    ...
    public void openAppDetailsForEn(@NonNull final Activity context, String... permissionShow) {
        QuickPermissionHelper.getInstance().openAppDetailsForEn(context, permissionShow);
    }
