 ...
 * @date 2019/6/2　15:02.
 */
public class QuickPermissionLog {
    /**
     * Print log
    ...
    public static void d(String logString) {
        ...
        if (QuickPermissionConfig.DEBUG) {
            Log.d(QuickPermissionConfig.LOG_TAG, logString);
        }
    }
    ...
    public static void e(String logString) {
        ...
        Log.e(QuickPermissionConfig.LOG_TAG, logString);
    }
}
