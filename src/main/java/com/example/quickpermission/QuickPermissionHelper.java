 ...
 * @date 2019/6/2　15:45.
 */
public class QuickPermissionHelper {
     ...
     * 单例对象 mHelper
     */
    private static volatile QuickPermissionHelper mHelper;
    /**
     * ResultMap, a singleton object
     * 单例对象 resultMap
     */
    private static volatile SparseArray<QuickPermissionResult> mResults;

    /**
     * 构造函数私有化
     */
    private QuickPermissionHelper() {
    }
     ...
     * @return
     */
    public static QuickPermissionHelper getInstance() {
        if (mHelper == null) {
            synchronized (QuickPermissionHelper.class) {
                if (mHelper == null) {
                    mHelper = new QuickPermissionHelper();
                }
            }
        }
        return mHelper;
     ...
     * @return
     */
    private static SparseArray<QuickPermissionResult> getResults() {
        if (mResults == null) {
            synchronized (QuickPermissionHelper.class) {
                if (mResults == null) {
     ...
     * @return
     */
    protected void requestPermission(@NonNull Activity context, int requestCode, QuickPermissionResult result, @NonNull String... permissions) {
        //保存结果回调
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, int[] grantResults, @NonNull Activity context) {
        ...
        QuickPermissionResult permissionResult = mResults.get(requestCode);
    ...
    protected void openAppDetails(@NonNull final Activity context, String... permissionShow) {
        ...
        builder.setPositiveButton("去手动授权", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                context.startActivityForResult(intent, QuickPermission.APP_SETTINGS_RC);
            }
        });
